...
@section('content')
    <form role="form" class="form-horizontal form-groups-bordered" method="post" action="{{ route('gen_representation.store') }}" enctype="multipart/form-data">
        ...
        <div class="form-group{{ $errors->any() ? ' has-error' : '' }}">
            <div class="col-md-3 " style="margin-top: -10px; padding-top: 10px; height: 333px">
                                ...
                                <div class="rcorners" style="margin-top: 20px">
                                    <div class="verticalLine">
                                        <div class="row">
                                            ...
                                            <div class="col-sm-9">
                                                <input type="number" class="form-control recorder" name="gen_representation_key" id="gen_representation_key" required autofocus/>
                                            </div>
                                        </div>
                                            ...
                                            <div class="col-sm-9">
                                                <select class="form-control recorder" name="id_fed_district" id="id_fed_district" required autofocus>
                                                    ...
                                                    @foreach($fed_district as $f)
                                                        <option value="{{ $f->id }}" >{{ $f->district_number }}</option>
                                                    @endforeach
                                                </select>
                                            </div>
                                        </div>
