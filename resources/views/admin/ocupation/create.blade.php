...
@section('content')
    <form role="form" class="form-horizontal form-groups-bordered" method="post" action="{{ route('ocupation.store') }}" enctype="multipart/form-data">
        ...
        <div class="form-group{{ $errors->any() ? ' has-error' : '' }}">
            <div class="col-md-3 " style="margin-top: -10px; padding-top: 10px; height: 246px">
                            ...
                            <div class="tab-pane active" id="data_tab" name="{{trans('admin.ocupation')}}">
                                <div class="rcorners" style="margin-top: 10px; height: 157px">
                                    <div class="verticalLine">
                                        <div class="row">
                                            <label for="occupation_name" class="col-sm-3 control-label">{{trans('admin.name')}}<span style="color: red">*</span></label>
                                            <div class="col-sm-9">
                                                <input type="text" class="form-control make_user recorder" name="occupation_name" id="occupation_name" required autofocus/>
                                            </div>
                                        </div>
                                    </div>
                                </div>
