...
@section('content')
    <form role="form" class="form-horizontal form-groups-bordered" method="post" action="{{ route('area.store') }}" enctype="multipart/form-data">
                ...
                <div class="panel minimal" >
                    ...
                    <div class="panel-body">
                        ...
                        <div class="tab-content">
                            <div class="tab-pane active" id="personal_data_tab" name="{{trans('admin.area')}}">
                                <div class="rcorners" style="margin-top: 20px">
                                    <div class="verticalLine">
                                        <div class="row">
                                            ...
                                            <div class="col-sm-9">
                                                <input type="number" class="form-control make_user recorder" name="area_key" id="area_key" required autofocus/>
                                            </div>
                                        </div>
                                            ...
                                            <div class="col-sm-9">
                                                <select id="loc_district_id" name="loc_district_id" class="form-control select2 recorder personal_data" >
                                                    ...
                                                    @foreach($loc_district as $l)
                                                        <option value="{{ $l->id }}" >{{ $l->district_number }}</option>
                                                    @endforeach
                                                </select>
                                            </div>
                                        </div>
