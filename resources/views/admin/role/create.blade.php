...
@section('content')
    <form role="form" class="form-horizontal form-groups-bordered" method="post" action="{{ route('role.store') }}">
        ...
        <div class="form-group{{ $errors->any() ? ' has-error' : '' }}">
            <div class="col-md-3 " style="margin-top: -10px; padding-top: 10px; height: 318px">
                <h4 class="roboto">{{trans('admin.data')}}</h4>
                <div class="rcorners" style="height: 392px; overflow-y: auto">
                ...
                <div class="panel minimal" >
                    ...
                    <div class="panel-body">
                        ...
                        <div class="tab-content">
                            <div class="tab-pane active" id="personal_data_tab" name="{{trans('admin.role')}}">
                                <div class="rcorners" style="margin-top: 20px; height: 303px">
                                        ...
                                        <div class="row" style="margin-top: 5px">
                                            ...
                                            <div class="col-sm-9">
                                                <select id="zone_id" name="zone_id" class="form-control select2 recorder">
                                                    <option value="" selected>--- {{trans('admin.select')}} ---</option>
                                                    @foreach($zone as $z)
                                                        <option value="{{ $z->id }}" >{{ $z->zone_key }}</option>
                                                    @endforeach
                                                </select>
                                            </div>
                                        </div>
