...
@section('content')
    <form role="form" class="form-horizontal form-groups-bordered" method="post" action="{{ route('phone_code.store') }}">
                ...
                <div class="panel minimal" >
                    ...
                    <div class="panel-body">
                        ...
                        <div class="tab-content">
                            <div class="tab-pane active" id="personal_data_tab" name="{{trans('admin.phone_code')}}">
                                <div class="rcorners" style="margin-top: 20px">
                                    <div class="verticalLine">
                                        <div class="row">
                                            ...
                                            <div class="col-sm-9">
                                                <input type="text" class="form-control make_user recorder" name="phone_code" id="phone_code" required autofocus/>
                                            </div>
                                        </div>
                                        <br/>
                                        <div class="row">
                                            ...
                                            <div class="col-sm-9">
                                                <input type="text" class="form-control make_user recorder" name="country" id="country" required autofocus/>
                                            </div>
                                        </div>
                                        <br/>
                                        <div class="row">
                                            ...
                                            <div class="col-sm-9">
                                                <select class="select2" name="flag_name" id="flag_name" data-allow-clear="true" required autofocus>
                                                    @foreach($arr as $item)
                                                        <option class="form-control make_user recorder" value="{{ $item }}">{{ $item }}</option>
                                                    @endforeach
                                                </select>
                                            </div>
                                        </div>
