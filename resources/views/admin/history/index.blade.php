...
@section('content')
    ...
    <div class="rcorners table-download" style="margin-top: 10px">
        <div class="icon" style="top: 15px; right: 20px;">
            @if(auth()->user()->get_Permission('HistoryController','exportData'))
    ...
    <script type="text/javascript">
        (function($){
            $(window).on('load',function(){
                ...
                history_table.closest( '.dataTables_wrapper' ).find( 'select' ).select2( {
                ...
                $('.exportData').click(function(e){
                    ...
                    var url = '{{ route('history.exportData', ['type', 'items']) }}'.replace('type', type);
                    if (items.length > 0)
