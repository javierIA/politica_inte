...
@section('content')
    <form role="form" class="form-horizontal form-groups-bordered" method="post" action="{{ route('loc_district.store') }}" enctype="multipart/form-data">
                                ...
                                <div class="rcorners" style="margin-top: 10px">
                                    <div class="verticalLine">
                                        <div class="row">
                                            ...
                                            <div class="col-sm-9">
                                                <input type="number" class="form-control make_user recorder" max="9999" min="0" name="district_number" id="district_number" required autofocus/>
                                            </div>
                                        </div>
                                    </div>
