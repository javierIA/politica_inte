...
@section('content')
    <form role="form" class="form-horizontal form-groups-bordered" method="post" action="{{ route('block.store') }}" enctype="multipart/form-data">
        {{ csrf_field() }}
        @if ($errors->any())
            <div class="row">
        ...
        <div class="form-group{{ $errors->any() ? ' has-error' : '' }}">
            <div class="col-md-3 " style="margin-top: -10px; padding-top: 10px">
                ...
                <div class="rcorners" style="height: 168px; overflow-y: auto">
                ...
                <div class="panel minimal" >
                    ...
                    <div class="panel-body">
                        <div class="tab-content">
                            <div class="tab-pane active" id="personal_data_tab" name="{{trans('admin.block')}}">
                                <div class="rcorners" style="margin-top: 10px">
                                    <div class="verticalLine">
                                        <div class="row">
                                            ...
                                            <div class="col-sm-9">
                                                <input type="number" class="form-control make_user recorder" name="block_key" id="block_key" required autofocus/>
                                            </div>
                                        </div>
                                            ...
                                            <div class="col-sm-9">
                                                <select class="select2 form-control recorder" name="section_id" id="section_id" data-allow-clear="true" required autofocus>
                                                    ...
                                                    @foreach($items as $item)
                                                        <option class=" make_user recorder" value="{{ $item->id }}">{{ $item->section_key }}</option>
                                                    @endforeach
                                                </select>
                                            </div>
                                        </div>
