...
@section('content')
    <form role="form" class="form-horizontal form-groups-bordered" method="post" action="{{ route('box_type.store') }}">
                ...
                <div class="panel minimal" >
                    ...
                    <div class="panel-body">
                        <div class="tab-content">
                            <div class="tab-pane active" id="personal_data_tab" name="{{trans('admin.box_type')}}">
                                <div class="rcorners" style="margin-top: 20px">
                                    <div class="verticalLine">
                                        <div class="row">
                                            ...
                                            <div class="col-sm-9">
                                                <input type="text" class="form-control make_user recorder" name="box_type_name" id="box_type_name" required autofocus/>
                                            </div>
                                        </div>
                                        ...
                                        <div class="row" style="margin-top: 5px">
                                            ...
                                            <div class="col-sm-9">
                                                <input type="number" class="form-control make_user recorder" name="quantity_per_box" id="quantity_per_box" autofocus/>
                                            </div>
                                        </div>
                                    </div>
                                </div>
