...
@section('content')
    <form role="form" class="form-horizontal form-groups-bordered" method="post" action="{{ route('fed_district.store') }}" enctype="multipart/form-data">
                                ...
                                <div class="rcorners" style="margin-top: 20px">
                                    ...
                                    <div class="verticalLine" style="margin-top: 10px">
                                        ...
                                        <div class="row" style="margin-top: 5px">
                                            ...
                                            <div class="col-sm-9">
                                                <select id="municipality_id" name="municipality_id" class="form-control select2 recorder" required>
                                                    <option value="" selected>--- {{trans('admin.select')}} ---</option>
