...
@section('content')
    <form role="form" class="form-horizontal form-groups-bordered person_form" method="post"
          action="{{ route('person.store') }}" enctype="multipart/form-data">
        ...
        <div class="form-group{{ $errors->any() ? ' has-error' : '' }}">
            <div class="col-md-3" style="margin-top: -10px; padding-top: 10px">
                <div class="rcorners" style="height: 160px; text-align: center;">
                    <a href="#" data-toggle="modal" data-target="#myModalViewCard"><img id="card"
                                                                                        src="{{ asset('images/avatar/default.png') }}"
                                                                                        style="height: 100%; max-width: 210px"></a>
                </div>
                <h4 class="roboto" style="margin-top: 15px;">{{trans('admin.person_information')}}</h4>
                <div class="rcorners" style="height: 440px; overflow-y: auto">
            ...
            <div class="col-md-9">
                <div class="col-md-12" style="margin-bottom: 15px">
                    <div class="col-md-12">
                        <div class="col-md-7">
                            <div class="top_rcorners"
                                 style="margin-left: -45px; color: #003756; font-family: 'Century Gothic'; width: 350px">
                                {{$title}}
                            </div>
                        </div>
                        <div class="col-md-5"
                             style="margin-left: -45px; color: #003756; font-family: 'Century Gothic'; width: 280px">
                    ...
                    <div class="col-md-7" style="margin-top: 10px; height: 60px">
                        <div class="rcorners" style="margin-left: -30px;">
                            <div class="col-md-offset-1 col-md-2 icon" id="personal_data_icon">
                                <i class="entypo-user" title="{{trans('admin.personal_data')}}"></i>
                            </div>
                            <div class="col-md-2 icon" id="file_icon">
                                <i class="entypo-vcard" title="{{trans('admin.card_pdf')}}"></i>
                            </div>
                            <div class=" col-md-2 icon" id="person_email_icon">
                                <i class="entypo-mail" title="{{trans('admin.email')}}"></i>
                            </div>
                            <div class="col-md-2 icon" id="person_cellphone_icon">
                                <i class="fa fa-mobile-phone" title="{{trans('admin.person_cellphone')}}" style="margin-top: 5px"></i>
                            </div>
                            <div class="col-md-2 icon" id="person_phone_icon">
                    ...
                    <div class="col-md-8" style="margin-top: 10px; margin-left: -45px; height: 60px; width: 310px">
                        <div class="rcorners" style="color: #003756; padding-top: 5px">
                            @foreach($networks as $net)
                                <div class="col-md-2" style="font-size: 20px; color: #D4D4D5"
                                     id="{{$net->name_social_network.'_icon'}}">
                                    <i class="{{empty($net->icon)? 'fa fa-cog': $net->icon}}"
                                       title="{{$net->name_social_network}}"></i>
                                </div>
                            @endforeach
                        </div>
                    </div>
                    ...
                    <div class="panel-heading">
                        ...
                        <div class="panel-options">
                            <ul class="nav nav-tabs">
                                ...
                                <li data-name="{!! trans('admin.political_responsabilities') !!}" id="li_political_responsabilities">
                        ...
                        <div class="tab-content">
                                ...
                                <div class="rcorners" style="height: 468px">
                                    <div class="verticalLine">
                                        <div class="row" data-class="promoter">
                                            ...
                                            <div class="col-sm-6">
                                                <input type="hidden" name="promoter" id="promoter"/>
                            ...
                            <div class="tab-pane" id="personal_data_tab" name="{{trans('admin.personal_data')}}">
                                <div class="rcorners" style="height: 468px">
                                    <div class="verticalLine">
                                        <div class="row">
                                            <label for="person_name"
                                                   class="col-sm-3 control-label">{{trans('admin.name').'(s)'}}<span
                                                        style="color: red">*</span></label>
                                            <div class="col-sm-9">
                                                <input type="text" class="form-control make_user recorder personal_data"
                                                       name="person_name" id="person_name" required autofocus/>
                                            </div>
                                        </div>
                                        <div class="row" style="margin-top: 5px">
                                            <label for="father_lastname"
                                                   class="col-sm-3 control-label">{{trans('admin.father_lastname')}}
                                                <span style="color: red">*</span></label>
                                            <div class="col-sm-9">
                                                <input type="text" class="form-control make_user recorder personal_data"
                                                       name="father_lastname" id="father_lastname" required autofocus/>
                                            </div>
                                        </div>
                                        <div class="row" style="margin-top: 5px">
                                            <label for="mother_lastname"
                                                   class="col-sm-3 control-label">{{trans('admin.mother_lastname')}}
                                                <span style="color: red">*</span></label>
                                            <div class="col-sm-9">
                                                <input type="text" class="form-control make_user recorder personal_data"
                                                       name="mother_lastname" id="mother_lastname" required autofocus/>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="verticalLine" style="margin-top: 20px">
                                        <div class="row">
                                            <label for="birth_date"
                                                   class="col-sm-3 control-label">{{trans('admin.birth_date')}}<span
                                                        style="color: red">*</span></label>
                                            <div class='input-group date col-sm-9 datetimepicker'
                                                 style="padding-right: 300px; padding-left: 15px;">
                                                <input type='text' class="form-control recorder personal_data"
                                                       name="birth_date" id="birth_date" required autofocus/>
                                        ...
                                        <div class="row" style="margin-top: 5px">
                                            <div class="col-sm-6">
                                                <label for="person_sex"
                                                       class="col-sm-6 control-label">{{trans('admin.person_sex')}}<span
                                                            style="color: red">*</span></label>
                                                <div class="col-sm-6    ">
                                                    <select id="person_sex" name="person_sex"
                                                            class="form-control select2 recorder personal_data"
                                                            style="width: 150px">
                                                        <option value="" selected>---{{trans('admin.select')}}---
                                                        </option>
                                            ...
                                            <div class="col-sm-6">
                                                <label for="id_fed_entity_born"
                                                       class="col-sm-2 control-label">{{trans('admin.fed_entity')}}<span
                                                            style="color: red">*</span></label>
                                                <div class="col-sm-10">
                                        ...
                                        <div class="row" style="margin-top: 5px">
                                            <label for="id_municipality_born"
                                                   class="col-sm-3 control-label">{{trans('admin.municipality')}}<span
                                                        style="color: red">*</span></label>
                                            <div class="col-sm-9">
                                    ...
                                    <div class="verticalLine" style="margin-top: 20px">
                                        <div class="row col-sm-offset-3">
                                            <label class="checkbox-inline col-sm-4" for="is_studying">
                                                <input type="checkbox" value="1" class="recorder" id="is_studying"
                                                       name="is_studying">{{trans('admin.studies')}}
                                            </label>
                                            <label class="checkbox-inline" for="is_working">
                                                <input type="checkbox" value="1" class="recorder" id="is_working"
                                                       name="is_working">{{trans('admin.works')}}
                                            </label>
                                        </div>

                                        <div class="row" style="margin-top: 15px">
                                            <label for="educ_level"
                                                   class="col-sm-3 control-label">{{ trans('admin.educ_level') }}<span
                                                        style="color: red">*</span></label>
                                            <div class="col-sm-9">
                                                <select class="form-control select2 recorder personal_data"
                                                        name="educ_level" id="educ_level" required autofocus>
                                                    <option value="" selected>--- {{trans('admin.select')}} ---</option>
                                        ...
                                        <div class="row" style="margin-top: 5px">
                                            <label for="occupation"
                                                   class="col-sm-3 control-label">{{ trans('admin.occupation') }}<span
                                                        style="color: red">*</span></label>
                                            <div class="col-sm-9">
                                                <select class="form-control select2" name="occupation" id="occupation"
                                                    ...
                                                    @foreach($occupations as $o)
                                                        <option value="{{ $o->id }}">{{ $o->occupation_name }}</option>
                                                    @endforeach
                                                </select>
                                            </div>
                                        </div>
                                    ...
                                    <div class="verticalLine" style="margin-top: 25px">
                                        <div class="row">
                                            <label for="territory_volunteer"
                                                   class="col-sm-7 control-label">{{trans('admin.territory_volunteer')}}</label>
                                            <label class="radio-container col-sm-offset-1 col-sm-1">{{trans('admin.yes')}}
                                                <input type="radio" checked="checked" name="territory_volunteer"
                                                       value="1" class="recorder">
                                                <span class="checkmark"></span>
                                            </label>
                                            <label class="radio-container col-sm-2">{{trans('admin.no')}}
                                                <input type="radio" name="territory_volunteer" value="0"
                                                       class="recorder">
                                                <span class="checkmark"></span>
                                            </label>
                                        </div>
                                        <div class="row">
                                            <label for="electoral_volunteer"
                                                   class="col-sm-7 control-label">{{trans('admin.electoral_volunteer')}}</label>
                                            <label class="radio-container col-sm-offset-1 col-sm-1">{{trans('admin.yes')}}
                                                <input type="radio" checked="checked" name="electoral_volunteer"
                                                       value="1" class="recorder">
                                                <span class="checkmark"></span>
                                            </label>
                                            <label class="radio-container col-sm-2">{{trans('admin.no')}}
                                                <input type="radio" name="electoral_volunteer" value="0"
                                                       class="recorder">
                                                <span class="checkmark"></span>
                                            </label>
                                        </div>
                            ...
                            <div class="tab-pane" id="contact_data_tab" name="{{trans('admin.contact_data')}}">
                                    ...
                                    <div class="verticalLine">
                                        <div class="row" data-class="id_oficial_address">
                                            <label for="id_oficial_address_text"
                                                ...
                                                <span style="color: red">*</span></label>
                                            <div class="col-sm-6">
                                                <input type="hidden" name="id_oficial_address" id="id_oficial_address"/>
                                            ...
                                            <div class="col-sm-offset-3" style="padding-left: 15px">
                                                <label class="checkbox-inline" for="i_live_check">
                                                    <input type="checkbox" value="1" class="recorder" id="i_live_check"
                                                           name="i_live_check"
                                                           style="margin-top:2px">{{trans('admin.i_live_at_my_official_address')}}
                                                </label>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="rcorners " style="margin-top: 20px; height: 371px">
                                    <div class="verticalLine">
                                        <div class="row">
                                            <label for="username" class="col-sm-3 control-label">{{trans('admin.user')}}
                                                <span style="color: red">*</span></label>
                                            <div class="col-sm-9">
                                                <input type="text" class="form-control recorder"
                                            ...
                                            <div class="row">
                                                <div class="col-sm-12">
                                                    <label for="person_phone"
                                                           class="col-sm-3 control-label">{{trans('admin.person_phone')}}</label>
                                                    <div class="col-sm-3">
                                                        <select class="form-control select2" name="phone_phone_code_id"
                                                                id="phone_phone_code_id" required autofocus>
                                                            @foreach($phone_codes as $pc)
                                                                <option value="{{ $pc->id }}">{{ $pc->phone_code }}</option>
                                                            @endforeach
                                                        </select>
                                                    </div>
                                                    <div class="col-sm-2">
                                                        <input type="tel" class="form-control check_data data_user"
                                                               id="lada_phone" name="lada_phone" placeholder="Lada" maxlength="3"
                                                               autofocus/>
                                                    </div>
                                                    <div class="col-sm-4">
                                                        <input type="tel"
                                                               class="form-control check_data recorder data_user"
                                                               id="person_phone" name="person_phone" pattern="[0-9]{7}"
                                                               autofocus/>
                                                    </div>
                                                </div>
                                                <div class="col-sm-12">
                                                    <div class="col-sm-offset-3 col-sm-3">
                                                        <label class="checkbox-inline" for="phone_is_smartphone">
                                                            <input type="checkbox" value="1" id="phone_is_smartphone"
                                                                   name="phone_is_smartphone"
                                                                   style="margin-top:2px">{{trans('admin.is_smartphone')}}
                                                        </label>
                                                    </div>
                                                </div>
                                            </div>
                                        ...
                                        <div class="row" style="margin-top: 10px">
                                            <div class="row">
                                                <div class="col-sm-12">
                                                    <label for="person_cellphone"
                                                           class="col-sm-3 control-label">{{trans('admin.person_cellphone')}}</label>
                                                    <div class="col-sm-3">
                                                        <select class="form-control select2"
                                                                name="cellphone_phone_code_id"
                                                                id="cellphone_phone_code_id" required autofocus>
                                                            @foreach($phone_codes as $pc)
                                                                <option value="{{ $pc->id }}">{{ $pc->phone_code }}</option>
                                                            @endforeach
                                                        </select>
                                                    ...
                                                    <div class="col-sm-2">
                                                        <input type="tel" class="form-control check_data data_user"
                                                               id="lada_cellphone" name="lada_cellphone" maxlength="3"
                                                               placeholder="Lada" autofocus/>
                                                    </div>
                                                    <div class="col-sm-4">
                                                        <input type="tel"
                                                               class="form-control check_data recorder data_user"
                                                               id="person_cellphone" name="person_cellphone"
                                                               pattern="[0-9]{7}" autofocus/>
                                                    </div>
                                                </div>
                                                <div class="col-sm-12">
                                                    <div class="col-sm-offset-3 col-sm-3">
                                                        <label class="checkbox-inline" for="cellphone_is_propietary">
                                                            <input type="checkbox" value="1"
                                                                   id="cellphone_is_propietary"
                                                                   name="cellphone_is_propietary"
                                                                   style="margin-top:2px">{{trans('admin.is_propietary')}}
                                                        </label>
                                                    </div>
                                                    <div class="col-sm-3">
                                                        <label class="checkbox-inline" for="cellphone_is_smartphone">
                                                            <input type="checkbox" value="1"
                                                                   id="cellphone_is_smartphone"
                                                                   name="cellphone_is_smartphone"
                                                                   style="margin-top:2px">{{trans('admin.is_smartphone')}}
                                                        </label>
                                                    </div>
                                                    <div class="col-sm-3">
                                                        <label class="checkbox-inline" for="cellphone_exclusive_use">
                                                            <input type="checkbox" value="1"
                                                                   id="cellphone_exclusive_use"
                                                                   name="cellphone_exclusive_use"
                                                                   style="margin-top:2px">{{trans('admin.exclusive_use')}}
                                                        </label>
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-sm-12">
                                                <div class="row">
                                                    <label for="person_email"
                                                           class="col-sm-3 control-label">{{trans('admin.email')}}<span
                                                                style="color: red">*</span></label>
                                                    <div class="col-sm-9">
                                                        <input type="text"
                                                               class="form-control recorder data_user check_data"
                                                               name="person_email" id="person_email" required
                                                               autofocus/>
                                                    </div>
                                                </div>
                                                <div class="col-sm-12">
                                                    <div class="col-sm-offset-3 col-sm-3">
                                                        <label class="checkbox-inline" for="person_email_is_propietary">
                                                            <input type="checkbox" value="1"
                                                                   id="person_email_is_propietary"
                                                                   name="person_email_is_propietary"
                                                                   style="margin-top:2px">{{trans('admin.is_propietary')}}
                                                        </label>
                                                    </div>
                                                    <div class="col-sm-6">
                                                        <label class="checkbox-inline" for="person_email_exclusive_use">
                                                            <input type="checkbox" value="1"
                                                                   id="person_email_exclusive_use"
                                                                   name="person_email_exclusive_use">{{trans('admin.exclusive_use')}}
                                                        </label>
                                                    </div>
                                                </div>
                                            </div>
                            ...
                            <div class="tab-pane" id="electoral_data_tab" name="{{trans('admin.contact_data')}}">
                                <div class="rcorners">
                                    <div class="verticalLine">
                                        <div class="row">
                                            <label for="elector_key"
                                                   class="col-sm-3 control-label">{{trans('admin.elector_key')}}<span
                                                        style="color: red">*</span></label>
                                            <div class="col-sm-9">
                                                <input type="text" class="form-control recorder" name="elector_key"
                                                       id="elector_key" maxlength="18" minlength="18" required autofocus/>
                                            </div>
                                        </div>
                                        <div class="row" style="margin-top: 5px">
                                            <label for="file"
                                                   class="col-sm-3 control-label">{{ trans('admin.card_pdf_front') }}
                                                <span style="color: red">*</span></label>
                                            <div class="col-sm-9">
                                                <input class="form-control ignore recorder data_user" type="file"
                                                       name="file[]" id="file" accept="png,jpeg"
                                                       onchange="PreviewImage();" required>
                                            </div>
                                        </div>
                                        <div class="row" style="margin-top: 5px">
                                            <label for="file1"
                                                   class="col-sm-3 control-label">{{ trans('admin.card_pdf_back') }}
                                                <span style="color: red">*</span></label>
                                            <div class="col-sm-9">
                                                <input class="form-control ignore recorder data_user" type="file"
                                                       name="file[]" id="file1" accept="png,jpeg" required>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                <div class="rcorners" style="margin-top: 20px; height: 323px">
                                    <div class="verticalLine">
                                        <div class="row">
                                    ...
                                    <div class="verticalLine" style="margin-top: 20px">
                                        <div class="row">
                                            <label for="id_fed_entity_text"
                                                   class="col-sm-3 control-label">{{ trans('admin.fed_entity') }}<span
                                                        style="color: red">*</span></label>
                                            <div class="col-sm-9">
                                                <input type="hidden" name="id_fed_entity" id="id_fed_entity"/>
                                                <input type="text" class="form-control " id="id_fed_entity_text"
                                                       disabled required autofocus/>
                                            </div>
                                        </div>
                                        <div class="row" style="margin-top: 5px">
                                            <label for="id_municipality_text"
                                                   class="col-sm-3 control-label">{{ trans('admin.municipality') }}<span
                                                        style="color: red">*</span></label>
                                            <div class="col-sm-9">
                                                <input type="hidden" name="id_municipality" id="id_municipality"/>
                                                <input type="text" class="form-control recorder"
                                                       id="id_municipality_text" disabled required autofocus/>
                                            </div>
                                        </div>
                                        <div class="row" style="margin-top: 5px">
                                            <label for="id_section"
                                                   class="col-sm-3 control-label">{{ trans('admin.section') }}<span
                                                        style="color: red">*</span></label>
                                            <div class="col-sm-9">
                                                <input type="hidden" name="id_section" id="id_section"/>
                                                <input type="text" class="form-control recorder" id="id_section_text"
                                                       disabled required autofocus/>
                                            </div>
                                        </div>
                                        <div class="row" data-class="id_real_address" id="id_real_address_div"
                                             style="margin-top: 10px">
                                            <label for="id_real_address_text"
                                                   class="col-sm-3 control-label">{{ trans('admin.real_address') }}<span
                                                        style="color: red">*</span></label>
                                            <div class="col-sm-6">
                                                <input type="hidden" name="id_real_address" id="id_real_address"/>
                                                <input type="text" class="form-control readonly recorder modal_input_button"
                            ...
                            <div class="tab-pane" id="networks_tab" name="{{trans('admin.networks')}}">
                                <div class="rcorners" style="height: 468px; overflow-y:auto; overflow-x:hidden;">
                                    <div class="verticalLine">
                                        @foreach($networks as $net)
                                            <div class="row" style="margin-top: 5px">
                                                <label for="{{$net->name_social_network}}"
                                                       class="col-sm-3 control-label">{{$net->name_social_network }}</label>
                                                <div class="col-sm-8">
                                                    {{--<input type="hidden" name="social_network[]" value="{{$net->id}}"/>--}}
                                                    <input type="text" class="form-control network_user recorder"
                                                           name="{{$net->name_social_network}}"
                                                           id="{{$net->name_social_network}}"
                                                           placeholder="{{trans('admin.insert_profile')}}" autofocus/>
                                                </div>
                                            </div>
                                        @endforeach
                                    </div>
                                ...
                                <div class="rcorners" style="height: 468px">
                                    <div class="form-group">
                                        <div class=" col-sm-offset-3 col-sm-7">
                                            <select multiple="multiple" name="my-select[]" id='my-select'
                                ...
                                <div class="rcorners">
                                    <div class="verticalLine">
                                        <div class="row">
                                            ...
                                            <div class="col-sm-9">
                                                <select id="id_political" name="id_political" class="form-control select2 recorder geografic_association">
                                                    <option value="" selected>--- {{trans('admin.select')}} ---</option>
                                ...
                                <div class="rcorners" style="margin-top: 10px; height:404px">
                                    <div class="verticalLine" style="margin-top: 10px">
                                        <div class="row" style="margin-top: 5px">
                                            ...
                                            <div class="col-sm-9">
                                                <select id="id_fed_entitys_political" name="id_fed_entitys_political" class="form-control select2 recorder">
                                                    <option value="" selected>--- {{trans('admin.select')}} ---</option>
                                                    @foreach($fed_entitys as $f)
                                                        <option value="{{ $f->id }}" >{{ $f->entity_name }}</option>
                                                    @endforeach
                                        ...
                                        <div class="row" style="margin-top: 5px">
                                            ...
                                            <div class="col-sm-9">
                                                <select id="id_municipality_political" name="id_municipality_political" class="form-control select2 recorder" >
                                                    <option value="" selected>--- {{trans('admin.select')}} ---</option>
                                                    @foreach($municipalitys as $m)
                                                        <option value="{{ $m->id }}" data-parent="{{$m->fed_entity_id}}">{{ $m->municipality_name }}</option>
                                                    @endforeach
                                    ...
                                    <div class="verticalLine" style="margin-top: 15px">
                                        <div class="row" style="margin-top: 5px">
                                            <label for="id_section_political" class="col-sm-3 control-label">{{trans('admin.section')}}</label>
                                            <div class="col-sm-9">
                                                <select id="id_section_political" name="id_section_political" class="form-control select2 recorder">
                                                    <option value="" selected>--- {{trans('admin.select')}} ---</option>
                                        ...
                                        <div class="row" style="margin-top: 5px">
                                            ...
                                            <div class="col-sm-9">
                                                <select id="id_block_political" name="id_block_political" class="form-control select2 recorder">
                                                    <option value="" selected>--- {{trans('admin.select')}} ---</option>
                                                    @foreach($block as $b)
                                                        <option value="{{ $b->id }}" >{{ $b->block_key }}</option>
                                                    @endforeach
                                                </select>
                                            </div>
                                        </div>
                                    ...
                                    <div class="verticalLine" style="margin-top: 15px">
                                        <div class="row" style="margin-top: 5px">
                                            ...
                                            <div class="col-sm-9">
                                                <select id="id_loc_district_political" name="id_loc_district_political" class="form-control select2 recorder">
                                                    <option value="" selected>--- {{trans('admin.select')}} ---</option>
                                                    @foreach($loc_district as $ld)
                                                        <option value="{{ $ld->id }}" >{{ $ld->district_number }}</option>
                                                    @endforeach
                                                </select>
                                            </div>
                                        </div>
                                        <div class="row" style="margin-top: 5px">
                                            ...
                                            <div class="col-sm-9">
                                                <select id="id_area_political" name="id_area_political" class="form-control select2 recorder">
                                                    <option value="" selected>--- {{trans('admin.select')}} ---</option>
                                                    @foreach($area as $a)
                                        ...
                                        <div class="row" style="margin-top: 5px">
                                            ...
                                            <div class="col-sm-9">
                                                <select id="id_zone_political" name="id_zone_political" class="form-control select2 recorder">
                                                    <option value="" selected>--- {{trans('admin.select')}} ---</option>
                                                    @foreach($zone as $z)
                                                        <option value="{{ $z->id }}" data-parent="{{$z->area_id}}">{{ $z->zone_key }}</option>
                                                    @endforeach
                                                </select>
                                            </div>
                                        </div>
                                    ...
                                    <div class="verticalLine" style="margin-top: 15px">
                                        <div class="row" style="margin-top: 5px">
                                            ...
                                            <div class="col-sm-9">
                                                <select id="id_fed_district_political" name="id_fed_district_political" class="form-control select2 recorder">
                                                    <option value="" selected>--- {{trans('admin.select')}} ---</option>
                                                    @foreach($fed_district as $fd)
                                                        <option value="{{ $fd->id }}">{{ $fd->district_number }}</option>
                                                    @endforeach
                                                </select>
                                            </div>
                                        </div>
                                ...
                                <div class="rcorners">
                                    <div class="verticalLine">
                                        <div class="row">
                                            ...
                                            <div class="col-sm-9">
                                                <select id="id_territorial" name="id_territorial" class="form-control select2 recorder geografic_association">
                                                    <option value="" selected>--- {{trans('admin.select')}} ---</option>
                                                    @foreach($functions as $f)
                                ...
                                <div class="rcorners" style="margin-top: 10px; height:404px">
                                    <div class="verticalLine" style="margin-top: 10px">
                                        <div class="row" style="margin-top: 5px">
                                            ...
                                            <div class="col-sm-9">
                                                <select id="id_fed_entitys_territorial" name="id_fed_entitys_territorial" class="form-control select2 recorder">
                                                    <option value="" selected>--- {{trans('admin.select')}} ---</option>
                                                    @foreach($fed_entitys as $f)
                                                        <option value="{{ $f->id }}" >{{ $f->entity_name }}</option>
                                                    @endforeach
                                        ...
                                        <div class="row" style="margin-top: 5px">
                                            ...
                                            <div class="col-sm-9">
                                                <select id="id_municipality_territorial" name="id_municipality_territorial" class="form-control select2 recorder" >
                                                    <option value="" selected>--- {{trans('admin.select')}} ---</option>
                                                    @foreach($municipalitys as $m)
                                                        <option value="{{ $m->id }}" data-parent="{{$m->fed_entity_id}}">{{ $m->municipality_name }}</option>
                                                    @endforeach
                                    ...
                                    <div class="verticalLine" style="margin-top: 15px">
                                        <div class="row" style="margin-top: 5px">
                                            ...
                                            <div class="col-sm-9">
                                                <select id="id_section_territorial" name="id_section_territorial" class="form-control select2 recorder">
                                                    <option value="" selected>--- {{trans('admin.select')}} ---</option>
                                                    @foreach($sections as $s)
                                                        <option value="{{ $s->id }}" data-parent="{{$s->municipality_id}}">{{ $s->section_key }}</option>
                                                    @endforeach
                                        ...
                                        <div class="row" style="margin-top: 5px">
                                            ...
                                            <div class="col-sm-9">
                                                <select id="id_block_territorial" name="id_block_territorial" class="form-control select2 recorder">
                                                    <option value="" selected>--- {{trans('admin.select')}} ---</option>
                                                    @foreach($block as $b)
                                                        <option value="{{ $b->id }}" >{{ $b->block_key }}</option>
                                                    @endforeach
                                    ...
                                    <div class="verticalLine" style="margin-top: 15px">
                                        <div class="row" style="margin-top: 5px">
                                            ...
                                            <div class="col-sm-9">
                                                <select id="id_loc_district_territorial" name="id_loc_district_territorial" class="form-control select2 recorder">
                                                    <option value="" selected>--- {{trans('admin.select')}} ---</option>
                                                    @foreach($loc_district as $ld)
                                                        <option value="{{ $ld->id }}" >{{ $ld->district_number }}</option>
                                                    @endforeach
                                        ...
                                        <div class="row" style="margin-top: 5px">
                                            ...
                                            <div class="col-sm-9">
                                                <select id="id_area_territorial" name="id_area_territorial" class="form-control select2 recorder">
                                                    <option value="" selected>--- {{trans('admin.select')}} ---</option>
                                                    @foreach($area as $a)
                                                        <option value="{{ $a->id }}" >{{ $a->area_key }}</option>
                                                    @endforeach
                                        ...
                                        <div class="row" style="margin-top: 5px">
                                            ...
                                            <div class="col-sm-9">
                                                <select id="id_zone_territorial" name="id_zone_territorial" class="form-control select2 recorder">
                                                    <option value="" selected>--- {{trans('admin.select')}} ---</option>
                                                    @foreach($zone as $z)
                                                        <option value="{{ $z->id }}" data-parent="{{$z->area_id}}">{{ $z->zone_key }}</option>
                                                    @endforeach
                                    ...
                                    <div class="verticalLine" style="margin-top: 15px">
                                        <div class="row" style="margin-top: 5px">
                                            ...
                                            <div class="col-sm-9">
                                                <select id="id_fed_district_territorial" name="id_fed_district_territorial" class="form-control select2 recorder">
                                                    <option value="" selected>--- {{trans('admin.select')}} ---</option>
                                                    @foreach($fed_district as $fd)
                                                        <option value="{{ $fd->id }}">{{ $fd->district_number }}</option>
                                                    @endforeach
        ...
        (function ($) {
            $(window).on('load', function () {
                $('.geografic_association').change(function() {
                    ...
                    if(it != null){
                        var temp = it.type === 'political'? '_political': '_territorial';
                        it.fed_entity === false? $('#id_fed_entitys'+ temp).parent().parent().hide(): $('#id_fed_entitys'+ temp).parent().parent().show();
                        it.municipality === false? $('#id_municipality'+ temp).parent().parent().hide(): $('#id_municipality'+ temp).parent().parent().show();
                        it.fed_district === false? $('#id_fed_district'+ temp).parent().parent().hide(): $('#id_fed_district'+ temp).parent().parent().show();
                        it.loc_district === false? $('#id_loc_district'+ temp).parent().parent().hide(): $('#id_loc_district'+ temp).parent().parent().show();
                        it.area === false? $('#id_area'+ temp).parent().parent().hide(): $('#id_area'+ temp).parent().parent().show();
                        it.zone === false? $('#id_zone'+ temp).parent().parent().hide(): $('#id_zone'+ temp).parent().parent().show();
                        it.section === false? $('#id_section'+ temp).parent().parent().hide(): $('#id_section'+ temp).parent().parent().show();
                        it.block === false? $('#id_block'+ temp).parent().parent().hide(): $('#id_block'+ temp).parent().parent().show();
                    }
                });
                ...
                $(".modal-form-address").submit(function (event) {
                    ...
                    $.post("{{route('address.post_add')}}",
                        ...
                        function (data, status) {
                            //$('#modal-form-add-address').trigger("reset");
                            //initMap();
                            if (status) {
                                var decoded_data = jQuery.parseJSON(data);
                ...
                $('#lada_phone').keyup(function(){
                    if($(this).val().length == 3)
                        $('#person_phone').focus();
                });

                $('#lada_cellphone').keyup(function(){
                    if($(this).val().length == 3)
