...
@section('breadcrumb')
    ...
    <li class="active">
        <a href="{{ route('person.index') }}">{{trans('admin.my_data')}}</a>
    </li>
@endsection

@section('content')
    <form role="form" class="form-horizontal form-groups-bordered person_form" method="post" action="{{ route('person.updateMyData', $person->id) }}" enctype="multipart/form-data">
            ...
            <div class="col-md-9">
                    ...
                    <div class="col-md-7" style="margin-top: 10px; height: 60px">
                        <div class="rcorners" style="margin-left: -30px;">
                            ...
                            <div class="col-md-2 icon" id="person_cellphone_icon">
                                <i class="fa fa-mobile-phone" title="{{trans('admin.person_cellphone')}}" style="margin-top: 5px  @if($person->getValidity('cellphone')) ;color: green @else ;color: yellow @endif"></i>
                            </div>
                            <div class="col-md-2 icon" id="person_phone_icon" style="color: yellow">
                ...
                <div class="col-md-12">
                    <div class="rcorners" style="margin-left: -15px; margin-bottom: 10px; color: #003756;">
                        ...
                        <div>
                            @if(!is_null($person->political_functions()->where('type', 'territorial')->first()))
                                &nbsp; 	&nbsp;{{trans('admin.territorial').': '. $person->political_functions()->where('type', 'territorial')->first()->name }}
                            @endif
                        </div>
                        <div>
                            @if(!is_null($person->political_functions()->where('type', 'political')->first()))
                                &nbsp; 	&nbsp;{{trans('admin.political').': '. $person->political_functions()->where('type', 'political')->first()->name }}
                            @endif
                        </div>
                    </div>
                </div>
                <div class="panel minimal" >
                    ...
                    <div class="panel-heading">
                        <div class="panel-title roboto">{!! trans('admin.personal_data') !!}</div>
                        <div class="panel-options">
                            <ul class="nav nav-tabs">
                                <li class="active" data-name="{!! trans('admin.personal_data') !!}">
                    ...
                    <div class="panel-body">
                        <div class="tab-content">
                            <div class="tab-pane active" id="personal_data_tab" name="{{trans('admin.personal_data')}}">
                                                ...
                                                <div class="col-sm-10">
                                                    <select id="id_fed_entity_born" name="id_fed_entity_born" class="form-control select2 recorder personal_data" style="width: 235px">
                                                        ...
                                                        @foreach($fed_entitys as $m)
                                                            <option value="{{ $m->id }}" @if($person->id_fed_entity_born == $m->id) selected @endif>{{ $m->entity_name }}</option>
                                                        @endforeach
                                                    </select>
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-sm-9">
                                                <select id="id_municipality_born" name="id_municipality_born" class="form-control select2 recorder personal_data">
                                                    ...
                                                    @foreach($municipalitys as $m)
                                                        <option value="{{ $m->id }}" @if($person->id_municipality_born == $m->id) selected @endif>{{ $m->municipality_name }}</option>
                                                    @endforeach
                                                </select>
                                            </div>
                                        </div>
                                ...
                                <div class="rcorners" style="margin-top: 20px; height: 289px">
                                    <div class="verticalLine">
                                        <div class="row">
                                            ...
                                            <div class='input-group date col-sm-9 datetimepicker'  style="padding-right: 300px; padding-left: 15px;">
                                                <input type='text' class="form-control recorder" name="credential_date" id="credential_date" value="{{$person->credential_date}}" required autofocus/>
                                                <span class="input-group-addon"> <span class="fa fa-calendar"></span></span>
                                            </div>
                                        </div>
                                    </div>
