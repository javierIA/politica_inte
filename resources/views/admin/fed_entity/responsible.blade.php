...
@section('content')
    <form role="form" class="form-horizontal form-groups-bordered" method="post" action="{{ route('fed_entity.saveResponsible', $fed_entity->id) }}">
        ...
        <div class="form-group{{ $errors->any() ? ' has-error' : '' }}">
            ...
            <div class="row" data-class="titular_person">
                ...
                <div class="col-sm-4">
                    ...
                    <input type="text" class="form-control input-lg" id="titular_person_text" value="{{ is_null($fed_entity->titular_person)? '': $fed_entity->titular_person()->get_full_name() }}" required readonly autofocus/>
                </div>
            ...
            <div class="row" data-class="vocal_person">
                ...
                <div class="col-sm-4">
                    ...
                    <input type="text" class="form-control input-lg" id="vocal_person_text" value="{{ is_null($fed_entity->vocal_person)? '': $fed_entity->vocal_person()->get_full_name() }}" required readonly autofocus/>
                </div>
                <button type="button" style="margin-top: 5px;" class="btn btn-blue btn-sm search_button" title="{{trans('admin.search_person')}}" data-toggle="modal" data-target="#myModal" data-class="vocal_person">
                    <i class="entypo-search"></i>
                </button>
                <button type="button" style="margin-top: 5px;" name="btnTrash" class="btn btn-danger btn-sm clean_button" title="{{trans('admin.clean')}}">
                    <i class="entypo-trash"></i>
            ...
            <div class="row" data-class="representative">
                ...
                <div class="col-sm-4">
                    ...
                    <input type="text" class="form-control input-lg" id="representative_text" value="{{ is_null($fed_entity->representative)? '': $fed_entity->representative()->get_full_name() }}" required readonly autofocus/>
                </div>
                <button type="button" style="margin-top: 5px;" class="btn btn-blue btn-sm search_button" title="{{trans('admin.search_person')}}" data-toggle="modal" data-target="#myModal" data-class="representative">
                    <i class="entypo-search"></i>
                </button>
                <button type="button" style="margin-top: 5px;" name="btnTrash" class="btn btn-danger btn-sm clean_button" title="{{trans('admin.clean')}}">
                    <i class="entypo-trash"></i>
            ...
            <div class="row" data-class="alternate">
                ...
                <div class="col-sm-4">
                    ...
                    <input type="text" class="form-control input-lg" id="alternate_text" value="{{ is_null($fed_entity->alternate)? '': $fed_entity->alternate()->get_full_name() }}" required readonly autofocus/>
                </div>
                <button type="button" style="margin-top: 5px;" class="btn btn-blue btn-sm search_button" title="{{trans('admin.search_person')}}" data-toggle="modal" data-target="#myModal" data-class="alternate">
                    <i class="entypo-search"></i>
                </button>
                <button type="button" style="margin-top: 5px;" name="btnTrash" class="btn btn-danger btn-sm clean_button" title="{{trans('admin.clean')}}">
                    <i class="entypo-trash"></i>
                ...
                <div class="modal-body" id="modalBody">
                    <form role="form" id="modal-form" class="form-horizontal form-groups-bordered" method="post">
                        ...
                        <div class="control-group col-sm-4">
                            <label for="id_fed_entity" class="control-label">{{ trans('admin.fed_entity') }}</label>
                            <select id="id_fed_entity" name="id_fed_entity" class="form-control select2-single person_filter">
                                <option selected>---{{trans('admin.select')}} ---</option>
                                @foreach($fed_entitys as $m)
                                    <option value="{{ $m->id }}" @if($m->id == $fed_entity->id) selected @endif>{{ ' ('. trans('admin.entity_key').': '.$m->entity_key . ') '.$m->entity_name }}</option>
                                @endforeach
                            </select>
                        </div>
                    ...
                    <table class="table table-bordered table-striped datatable" id="search-person-table" style="width: 100%">
                        ...
                        <tr>
                            ...
                            <th style="width: 40%;">{{trans('admin.entity_key')}}</th>
