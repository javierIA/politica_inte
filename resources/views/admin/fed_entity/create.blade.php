...
@section('content')
    <form role="form" class="form-horizontal form-groups-bordered" method="post" action="{{ route('fed_entity.store') }}" enctype="multipart/form-data">
                                ...
                                <div class="rcorners" style="margin-top: 20px">
                                    <div class="verticalLine">
                                        <div class="row">
                                            ...
                                            <div class="col-sm-9">
                                                <input type="number" class="form-control make_user recorder" max="9999" min="0" name="entity_key" id="entity_key" required autofocus/>
                                            </div>
                                        </div>
                                        <br/>
                                        <div class="row">
                                            ...
                                            <div class="col-sm-9">
                                                <input type="text" class="form-control make_user recorder" name="entity_name" id="entity_name" required autofocus/>
                                            </div>
                                        </div>
                                        <br/>
                                        <div class="row">
