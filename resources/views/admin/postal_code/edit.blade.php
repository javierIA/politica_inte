...
@section('content')
    <form role="form" class="form-horizontal form-groups-bordered" method="post" action="{{ route('postal_code.update', $postalCode) }}">
                                ...
                                <div class="rcorners" style="margin-top: 20px">
                                    <div class="verticalLine">
                                        <div class="row">
                                            ...
                                            <div class="col-sm-9">
                                                <input type="text" class="form-control make_user recorder" name="number" id="number" value="{{$postalCode->number}}" required autofocus/>
                                            </div>
                                        </div>
                                            ...
                                            <div class="col-sm-9">
                                                <select id="id_fed_entity" name="id_fed_entity" class="form-control select2 recorder personal_data" >
                                                    ...
                                                    @foreach($fed_entitys as $m)
                                                        <option value="{{ $m->id }}" @if($m->id == $postalCode->fed_entity_id) selected @endif>{{ $m->entity_name }}</option>
                                                    @endforeach
                                                </select>
                                            </div>
                                        </div>
                                            ...
                                            <div class="col-sm-9">
                                                <select id="municipality_id" name="municipality_id" class="form-control select2 recorder personal_data" >
                                                    ...
                                                    @foreach($municipality as $m)
                                                        <option value="{{ $m->id }}" @if($m->id == $postalCode->municipality_id) selected @endif >{{ $m->municipality_name }}</option>
                                                    @endforeach
                                                </select>
                                            </div>
                                        </div>
                                        <div class="row" style="margin-top: 5px">
                                            ...
                                            <div class="col-sm-9">
                                                <input type="text" class="form-control autocomplete"
                                                       ...
                                                       data-data="name"
                                                       value="{{$postalCode->colony}}"
                                                       name="colony" id="colony" required autofocus/>
                                            </div>
                                        </div>
                                    </div>
                                </div>
