...
@section('content')
    <form role="form" class="form-horizontal form-groups-bordered" method="post" action="{{ route('validation.update', $validation) }}">
                ...
                <div class="panel minimal" >
                    ...
                    <div class="panel-body">
                        ...
                        <div class="tab-content">
                            <div class="tab-pane active" id="validation_tab" name="{{trans('admin.validation')}}">
                                <div class="rcorners" style="margin-top: 20px">
                                    <div class="verticalLine">
                                        <div class="row">
                                            ...
                                            <div class="col-sm-9">
                                                 <input type="text" class="form-control make_user recorder" name="name" id="name" value="{{$validation->name}}" required autofocus/>
                                            </div>
                                        </div>
                                        ...
                                        <div class="row">
                                            <div class="col-sm-offset-3" style="padding-left: 15px">
                                                <label class="checkbox-inline" for="active">
                                                    <input type="checkbox" value="1" class="recorder" id="active" name="active" style="margin-top:2px" @if($validation->active) checked @endif>{{trans('admin.active')}}
                                                </label>
                                            </div>
                                        </div>
                                    </div>
