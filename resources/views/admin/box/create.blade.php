...
@section('content')
    <form role="form" class="form-horizontal form-groups-bordered" method="post" action="{{ route('box.store') }}" enctype="multipart/form-data">
        ...
        <div class="form-group{{ $errors->any() ? ' has-error' : '' }}">
            <div class="col-md-3 " style="margin-top: -10px; padding-top: 10px; height: 400px">
                ...
                <div class="panel minimal" >
                    ...
                    <div class="panel-body">
                        ...
                        <div class="tab-content">
                            <div class="tab-pane active" id="personal_data_tab" name="{{trans('admin.box')}}">
                                <div class="rcorners" style="margin-top: 20px">
                                    <div class="verticalLine">
                                            ...
                                            <div class="col-sm-9">
                                                <select class="select2 form-control recorder" name="id_section" id="id_section" data-allow-clear="true" required autofocus>
                                                    ...
                                                    @foreach($section as $item)
                                                        <option value="{{ $item->id }}">{{ $item->section_key }}</option>
                                                    @endforeach
                                                </select>
                                            </div>
                                        </div>
                                            ...
                                            <div class="col-sm-9">
                                                <select class="select2 form-control recorder" name="id_box_type" id="id_box_type" data-allow-clear="true" required autofocus>
                                                    ...
                                                    @foreach($type as $item)
                                                        <option value="{{ $item->id }}">{{ $item->box_type_name }}</option>
                                                    @endforeach
                                                </select>
                                            </div>
                                        </div>
                                        ...
                                        <div class="row" style="margin-top: 5px">
                                            ...
                                            <div class="col-sm-9">
                                                <input type="text" class="form-control recorder"  name="owner_name" id="owner_name" autofocus/>
                                            </div>
                                        </div>
...
{{--                                            <div class="col-sm-9" >--}}
{{--                                                <textarea style="resize:none; height: 91px"   class="form-control recorder" name="address_text" id="address_text"  ></textarea>--}}
{{--                                            </div>--}}
{{--                                        </div>--}}
                                       ...
                                       {{-- <div class="row" data-class="owner" style="margin-top: 5px">
                                        ...
                                        <div class="row" style="margin-top: 5px">
                                            ...
                                            <div class="col-sm-9">
                                                <input  class="form-control recorder" type="file" name="file" id="file" accept="application/pdf">
                                            </div>
                                        </div>
