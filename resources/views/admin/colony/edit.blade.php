...
@section('breadcrumb')
    ...
    <li>
        <a href="{{ route('colony.index') }}">{{ trans('admin.colony') }}</a>
    </li>
    <li class="active">
        <strong>{{$title}}</strong>
    </li>
...
@section('content')
    <form role="form" class="form-horizontal form-groups-bordered" method="post" action="{{ route('colony.update', $colony) }}">
            ...
            <div class="col-md-8">
                ...
                <div class="panel minimal" >
                    ...
                    <div class="panel-heading">
                        <div class="panel-title roboto">{!! trans('admin.colony') !!}</div>
                        <div class="panel-options">
                            <ul class="nav nav-tabs">
                                <li class="active" data-name="{!! trans('admin.colony') !!}">
                    ...
                    <div class="panel-body">
                        <div class="tab-content">
                            <div class="tab-pane active" id="data_tab" name="{{trans('admin.colony')}}">
                                <div class="rcorners" style="margin-top: 10px; height: 157px">
                                    <div class="verticalLine">
                                        <div class="row">
                                            ...
                                            <div class="col-sm-9">
                                                <input type="text" class="form-control make_user recorder" name="name" id="name" value="{{$colony->name}}" required autofocus/>
                                            </div>
                                        </div>
                                    </div>
                                </div>
