...
@section('content')
    <form role="form" class="form-horizontal form-groups-bordered" method="post" action="{{ route('political_function.store') }}">
                                ...
                                <div class="rcorners" style="margin-top: 10px; height:280px">
                                    <div class="verticalLine">
                                        ...
                                        <div class="row" style="margin-top: 5px">
                                            ...
                                            <div class="col-sm-9">
                                                <textarea class="form-control make_user recorder" style="resize:none; height: 100px" id="description" name="description"></textarea>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="rcorners" style="margin-top: 10px; height:280px">
                                    <div class="verticalLine">
                                        <div class="row">
                                            ...
                                            <div class="col-sm-9">
                                                <input type="checkbox" value="1" class="recorder" id="fed_entity" name="fed_entity" style="margin-top: 10px" checked>
                                            </div>
                                        </div>
                                        <div class="row" style="margin-top: 5px">
                                            <label for="municipality" class="col-sm-3 control-label">{{trans('admin.municipality')}}</label>
                                            <div class="col-sm-9">
                                                <input type="checkbox" value="1" class="recorder" id="municipality" name="municipality" style="margin-top: 10px" checked>
                                            </div>
                                        </div>
                                        ...
                                        <div class="row" style="margin-top: 5px">
                                            ...
                                            <div class="col-sm-9">
                                                <input type="checkbox" value="1" class="recorder" id="fed_district" name="fed_district" style="margin-top: 10px" checked>
                                            </div>
                                        </div>
                                        ...
                                        <div class="row" style="margin-top: 5px">
                                            ...
                                            <div class="col-sm-9">
                                                <input type="checkbox" value="1" class="recorder" id="loc_district" name="loc_district" style="margin-top: 10px" checked>
                                            </div>
                                        </div>
                                        ...
                                        <div class="row" style="margin-top: 5px">
                                            ...
                                            <div class="col-sm-9">
                                                <input type="checkbox" value="1" class="recorder" id="area" name="area" style="margin-top: 10px" checked>
                                            </div>
                                        </div>
                                        ...
                                        <div class="row" style="margin-top: 5px">
                                            ...
                                            <div class="col-sm-9">
                                                <input type="checkbox" value="1" class="recorder" id="zone" name="zone" style="margin-top: 10px" checked>
                                            </div>
                                        </div>
                                        ...
                                        <div class="row" style="margin-top: 5px">
                                            ...
                                            <div class="col-sm-9">
                                                <input type="checkbox" value="1" class="recorder" id="section" name="section" style="margin-top: 10px" checked>
                                            </div>
                                        </div>
                                        ...
                                        <div class="row" style="margin-top: 5px">
                                            ...
                                            <div class="col-sm-9">
                                                <input type="checkbox" value="1" class="recorder" id="block" name="block" style="margin-top: 10px" checked>
                                            </div>
                                        </div>
                                    </div>
                                </div>
