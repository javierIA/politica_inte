...
@section('breadcrumb')
    ...
    <li>
        <a href="{{ route('street.index') }}">{{ trans('admin.street') }}</a>
    </li>
    <li class="active">
        <strong>{{$title}}</strong>
    </li>
...
@section('content')
    <form role="form" class="form-horizontal form-groups-bordered" method="post" action="{{ route('street.update', $street) }}" enctype="multipart/form-data">
        ...
        <div class="form-group{{ $errors->any() ? ' has-error' : '' }}">
            <div class="col-md-3" style="margin-top: -10px; padding-top: 10px; height: 332px">
            ...
            <div class="col-md-8">
                ...
                <div class="panel minimal" >
                    ...
                    <div class="panel-heading">
                        <div class="panel-title roboto">{!! trans('admin.street') !!}</div>
                        <div class="panel-options">
                            <ul class="nav nav-tabs">
                                <li class="active" data-name="{!! trans('admin.street') !!}">
                    ...
                    <div class="panel-body">
                        <div class="tab-content">
                            <div class="tab-pane active" id="street_tab" name="{{trans('admin.street')}}">
                                <div class="rcorners" style="margin-top: 20px">
                                    <div class="verticalLine">
                                        <div class="row">
                                            ...
                                            <div class="col-sm-9">
                                                <input type="text" class="form-control make_user recorder" name="name" id="name" value="{{$street->name}}" required autofocus/>
                                            </div>
                                        </div>
                                    </div>
                                </div>
