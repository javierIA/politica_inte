...
@section('content')
    <form role="form" class="form-horizontal form-groups-bordered" method="post" action="{{ route('section.store') }}" enctype="multipart/form-data">
        ...
        <div class="form-group{{ $errors->any() ? ' has-error' : '' }}">
            <div class="col-md-3 " style="margin-top: -10px; padding-top: 10px; height: 374px">
                                ...
                                <div class="rcorners" style="margin-top: 10px">
                                    <div class="verticalLine">
                                        <div class="row">
                                            ...
                                            <div class="col-sm-9">
                                                <input type="number" class="form-control make_user recorder" name="section_key" id="section_key" required autofocus/>
                                            </div>
                                        </div>
