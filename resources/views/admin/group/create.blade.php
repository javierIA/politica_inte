...
@section('content')
    <form role="form" class="form-horizontal form-groups-bordered" method="post" action="{{ route('group.store') }}">
                ...
                <div class="panel minimal" >
                    ...
                    <div class="panel-body">
                        ...
                        <div class="tab-content">
                            <div class="tab-pane active" id="personal_data_tab" name="{{trans('admin.group')}}">
                                <div class="rcorners" style="margin-top: 20px">
                                    <div class="verticalLine">
                                        <div class="row">
                                            ...
                                            <div class="col-sm-9">
                                                <input type="text" class="form-control make_user recorder" name="group_name" id="group_name" required autofocus/>
                                            </div>
                                        </div>
                                        <div class="row">
                                            <label for="default" class="col-sm-3 control-label">{{ trans('admin.default') }}<span style="color: red">*</span></label>
                                            <div class="col-sm-9">
                                                <input type="checkbox" value="1" class="recorder" id="default" name="default">
                                            </div>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-sm-9" >
                                                <textarea style="resize:none; height: 91px"   class="form-control make_user recorder" name="description" id="description"  ></textarea>
                                            </div>
                                        </div>
