...
@section('content')
    <form role="form" class="form-horizontal form-groups-bordered" method="post" action="{{ route('municipality.store') }}" enctype="multipart/form-data">
                ...
                <div class="panel minimal" >
                    ...
                    <div class="panel-body">
                        ...
                        <div class="tab-content">
                            <div class="tab-pane active" id="personal_data_tab" name="{{trans('admin.municipality')}}">
                                <div class="rcorners">
                                    <div class="verticalLine">
                                        <div class="row">
                                            <label for="municipality_key" class="col-sm-3 control-label">{{trans('admin.municipality_key')}}<span style="color: red">*</span></label>
                                            <div class="col-sm-9">
                                                <input type="number" class="form-control make_user recorder" max="9999" min="0" name="municipality_key" id="municipality_key" required autofocus/>
                                            </div>
                                        </div>
                                        <br/>
                                        <div class="row"  style="margin-top: 5px">
                                            ...
                                            <div class="col-sm-9">
                                                <input type="text" class="form-control make_user recorder" name="municipality_name" id="municipality_name" required autofocus/>
                                            </div>
                                        </div>
                                        <div class="row" style="margin-top: 5px">
